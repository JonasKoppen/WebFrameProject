...
@Component({
selector: 'app-veloMapAll',
templateUrl: 'veloMapAll.component.html',
styleUrls: ['./veloMapAll.component.scss'],
providers:[VeloService]
}) 
export class VeloMapAllComponent implements OnInit{
    title = 'veloMap';
    ...
    dichtBij: marker[]
    test : IVeloStation[]
    dataTitle="Velo stations dichtbij marker"
